...
using Steamworks;
using stormWeaverStaffEX.Projectiles;
using System;
...
namespace stormWeaverStaffEX.Items
{
    ...
    {
        public override string Texture => "stormWeaverStaffEX/Items/Familiar/FamiliarHead";
    ...
    public class FamiliarPlayer : ModPlayer
    {
        ...
        {
            /*var tex1 = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/Familiar/FamiliarBody").Value;
            var tex2 = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/Familiar/FamiliarTail").Value;
            ...
            public Dictionary<FamiliarType, Tuple<string, int, string, Color>> armorDict = new Dictionary<FamiliarType, Tuple<string, int, string, Color>>()
        {
            ...
            public override bool PreDraw(ref Color lightColor)
            {
                ...
                Texture2D texBody = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/Familiar/FamiliarBody" + armorDict[modplayer.familiarType].Item1, (AssetRequestMode)2).Value;
                Texture2D texTail = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/Familiar/FamiliarTail" + armorDict[modplayer.familiarType].Item1, (AssetRequestMode)2).Value;
            Texture2D texG = ModContent.Request<Texture2D>(Texture + armorDict[modplayer.familiarType].Item1 + "Glow", (AssetRequestMode)2).Value;
            Texture2D texBodyG = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/Familiar/FamiliarBody" + armorDict[modplayer.familiarType].Item1 + "Glow", (AssetRequestMode)2).Value;
            Texture2D texTailG = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/Familiar/FamiliarTail" + armorDict[modplayer.familiarType].Item1 + "Glow", (AssetRequestMode)2).Value; 
        ...
        {
            public override string Texture => "stormWeaverStaffEX/Items/Familiar/FamiliarBody";
        ...
        {
            public override string Texture => "stormWeaverStaffEX/Items/Familiar/FamiliarTail";
            public bool armored = true;
            public int segmentIndex = 1;
