...
namespace stormWeaverStaffEX.Items
{
    ...
    public class TailDraw : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            /*if (texture == null)
            {
                texture = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/MandibleReplica_Back");
            }
            int b = 0;
            ...
            var tex1G = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/Familiar/FamiliarBodyGlow").Value;
            var tex2G = ModContent.Request<Texture2D>("stormWeaverStaffEX/Items/Familiar/FamiliarTailGlow").Value;
